...
fwrite(tbia1, "C:/Users/taibi/Documents/GitHub/TBIA-data-review/02.processed_data/ver5_ver20240704_shiny/tbia_habitat.csv",
       row.names = F, quote = T)
```
...
tbia <- fread("C:/Users/taibi/Documents/GitHub/TBIA-data-review/02.processed_data/ver5_ver20240704_shiny/tbia_habitat.csv", 
              sep = ",", colClasses = "character", encoding = "UTF-8", na.strings = c("", "NA", "N/A"))
...
sum(group.all$taicol.count) # 63,789 species level
